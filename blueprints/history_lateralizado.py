...
def get_history_lateralizado_data():
    ...
    history_data_query = db.session.query(
        ...
        HistoryLateralizado._202303_INDUSTRY_NAME.label("Industry"),
        Siila3Table.REGISTRY.label("Registry"),
        HistoryLateralizado._202303_CONTACT_NAME.label("Tenant Contact"),
        HistoryLateralizado._202303_CONTACT_PHONE.label("Tenant Contact Phone"),
        HistoryLateralizado._202303_CONTACT_EMAIL.label("Tenant Contact Email")
    ).join(
