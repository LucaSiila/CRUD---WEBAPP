	...
	$(document).ready(function () {
		...
		var table = new Tabulator("#history-lateralizado-table", {
			...
			columns: [
				...
				{title:"SiiLA ID", field:"SIILA1_ID", frozen:true},
				{title:"NOME", field:"SIILA1_NAME", frozen:true},
				{title:"REGIÃO SiiLA", field:"REGION_NAME", frozen:true},
				{title:"CLASSE", field:"CLASS"},
				{title:"DATA DE ENTREGA", field:"DELIVERY_DATE", frozen:true},
				{title:"STATUS", field:"STATUS"},
				{title:"ANDAR", field:"SIILA2_NAME", frozen:true},
				{title:"CONJUNTO", field:"SIILA3_NAME", frozen:true},
